...
default_stat_names = [
    ...
    # "TtlSigInval",
    # "TtlSigVal"
 "cpuLoadSys", "memFree", "secC2C",  "transH/sec",

   "trans/sec", "lastSeq",
    "q1", "q2", "q3", "q4",
    "transEvent", "transCons", "trans/event", "trans/sec_sys",
    "dupEv%", "sec/sync4", "ev/syncS", "ev/syncR",
    "SecC2H", "bytes/sec_sync",
    # "fcmCreate", "fcmUpdate", "fcmTransfer", "fcmDelete",
    # "fileCreate", "fileUpdate", "fileAppend", "fileDelete",
        "submitMessageRcv","submitMessageRcv/sec","submitMessageSub","submitMessageSub/sec",  
      
"contractCallMethodRcv","contractCallMethodRcv/sec","contractCallMethodSub","contractCallMethodSub/sec",
...
#
# skip lines to reach the start time stamp quicly
#
def skip_lines(currentTimeStr, startTimeStr):
    currentTimeValue = datetime_from_isformat(currentTimeStr.replace(" UTC", "")).timestamp()
    startTimeValue = datetime_from_isformat(startTimeStr.replace(" UTC", "")).timestamp()
    lines = (startTimeValue - currentTimeValue)/3
